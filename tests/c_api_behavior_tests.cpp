...
void testAppShellAbiCreatesReusableSlots() {
    ...
    oneui_status_strip_set_icon(strip, 30); // IconSymbol::CheckCircle in the C ABI.
    ...
    oneui_status_strip_set_primary_action_presentation(strip, 1);
    oneui_status_strip_set_primary_action_trailing_icon(strip, 48);
...
void testOperationalWorkspacePrimitivesAbi() {
    ...
    expectTrue(
        ...
        list != nullptr && chart != nullptr && titleBar != nullptr && leading != nullptr && accessory != nullptr);
    ...
    oneui_virtual_list_set_rich_metrics(list, 18.0f, 8.0f, 18.0f, 4.0f, 12.0f, 6.0f, 54.0f, 6.0f);
